  ...
  public: {
    Tables: {
      ...
      avito_product_groups: {
        ...
        Relationships: [
          {
            foreignKeyName: "avito_product_groups_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      stores: {
        Row: {
          ...
          retail_marquee_bg_color: string | null
          retail_marquee_speed: number | null
