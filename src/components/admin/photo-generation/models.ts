...
export const KIE_MODELS: KieModel[] = [
  ...
  {
    id: "google/nano-banana-2-4k",
    label: "Google Nano Banana 2 · 4K",
    priceUsd: 0.09,
    supportsEdit: true,
    supportsTextToImage: true,
    description: "Максимальное разрешение 4K — для постеров и крупных рендеров",
  },
  {
    id: "google/nano-banana-2-2k",
    label: "Google Nano Banana 2 · 2K",
    priceUsd: 0.06,
    supportsEdit: true,
    supportsTextToImage: true,
    description: "2K разрешение — баланс качества и цены",
  },
  {
    id: "google/nano-banana-2-1k",
    label: "Google Nano Banana 2 · 1K",
    priceUsd: 0.04,
    supportsEdit: true,
    supportsTextToImage: true,
    description: "1K разрешение — самый дешёвый вариант Nano Banana 2",
  },
  {
