        ...
        <div className="bg-background rounded-t-3xl shadow-2xl max-h-[85vh] flex flex-col overflow-hidden">
          ...
          {cart.length === 0 ? (
            ...
            <>
              ...
              <div className="border-t border-border bg-background px-5 pt-4 pb-6 safe-area-bottom">
                {/* Minimum order warning */}
                {!canCheckout && minOrderAmount > 0 && (
                  <div className="bg-amber-500/10 text-amber-600 dark:text-amber-400 text-sm rounded-lg px-3 py-2 mb-3">
