...
export default function RetailCheckout({ subdomain: propSubdomain }: RetailCheckoutProps = {}) {
    ...
    return (
      <div className="retail-theme min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Розничный магазин не активирован</p>
        </div>
      </div>
    );
  }
      ...
      <div className="retail-theme min-h-screen bg-background">
        ...
        <header className="sticky top-0 z-40 bg-background/95 backdrop-blur border-b border-border">
          <div className="container mx-auto px-4 py-4 flex items-center gap-3">
            {store.retail_logo_url || store.logo_url ? (
              <img
                src={store.retail_logo_url || store.logo_url || ""}
                alt={store.retail_name || store.name}
