...
import { ArrowLeft, ShoppingCart, MapPin, User, Phone, MessageSquare, Loader2, CheckCircle2, Package } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { Textarea } from "@/components/ui/textarea";
import { useWholesaleStore } from "@/hooks/useWholesaleStore";
import { useWholesaleCart, WholesaleCartItem } from "@/hooks/useWholesaleCart";
...
export default function WholesaleCheckout() {
  ...
  const { cart, cartTotal, clearCart } = useWholesaleCart(subdomain || null);
  ...
  const isFormValid = name.trim() && phone.length >= 10 && address.trim() && canCheckout;
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="bg-muted/50 rounded-xl p-4 mb-8 text-left">
              ...
              <ul className="text-sm text-muted-foreground space-y-1.5">
                ...
                <li>• Вы получите подтверждение заказа</li>
        ...
        <div className="max-w-lg mx-auto space-y-6">
          ...
          <section className="bg-muted/30 rounded-2xl p-4 border border-border/50">
            ...
            {!canCheckout && minOrderAmount > 0 && (
              <div className="mt-3 bg-amber-500/10 text-amber-600 dark:text-amber-400 text-sm rounded-lg px-3 py-2">
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Пожелания к заказу, условия доставки, способ оплаты..."
                  className="min-h-[80px] resize-none"
                />
              </div>
            </section>
